Vagrant.configure("2") do |config|
  ...
  config.vm.define :node1 do |node1|
    ...
    node1.vm.network :private_network, ip: "192.168.10.41"
    node1.vm.hostname = "node1"
  end
  
    config.vm.define :node2 do |node2|
    node2.vm.box = "bento/ubuntu-20.04"
    node2.vm.network :private_network, ip: "192.168.10.42"
    node2.vm.hostname = "node2"
  end
  
    config.vm.define :node3 do |node3|
    node3.vm.box = "bento/ubuntu-20.04"
    node3.vm.network :private_network, ip: "192.168.10.43"
    node3.vm.hostname = "node3"
  end
  
    config.vm.define :node4 do |node4|
    node4.vm.box = "bento/ubuntu-20.04"
    node4.vm.network :private_network, ip: "192.168.10.44"
